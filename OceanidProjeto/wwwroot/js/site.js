...
function toggleTheme() {
    ...
    if (current === "dark") {
        html.setAttribute("data-bs-theme", "light"); // Altera atributo do tema
        localStorage.setItem("theme", "light"); // Salva preferência
        icon.className = "bi bi-moon"; // Altera ícone para lua
        ...
        icon.className = "bi bi-sun"; // Altera ícone para sol
...
// Função que aplica o tema salvo ao carregar a página
function applySavedTheme() {
    // Obtém o tema salvo no localStorage
    let savedTheme = localStorage.getItem("theme");

    // Se não existir tema salvo, define 'light' como padrão
    if (!savedTheme) {
        savedTheme = "light";
...
// Quando a página terminar de carregar, aplica o tema salvo
...
function carregarProduto() {
    ...
    document.getElementById("imgmaquiagem").src = produto.imgmaquiagem;
    document.getElementById("imgcabelo").src = produto.imgcabelo;
    document.getElementById("imgperfume").src = produto.imgperfume;
